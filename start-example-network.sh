#!/bin/bash
#
# This script will setup a simple FabCar Network with running Couchdb and Blockchain Explorer
...
# Now install, instantiate chaincode
...
printf "Open localhost:8080 to see the Blockchain Explorer Web-Interface\n\n"
